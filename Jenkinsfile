pipeline {
    ...
    environment {
        ...
        DOCKER_HUB_REPO = 'ouail02/recommendation-system-service'
        SPRING_PROFILES_ACTIVE = 'production'
        BRANCH = 'main'
        Git_REPO = 'https://github.com/ZOHSGroupe/ML-system-recommendation'
    }
    ...
    stages {
        ...
        stage('Build Docker Image') {
            steps {
                sh "docker-compose build -t ${DOCKER_HUB_REPO}:${env.BUILD_NUMBER} ."
            }
        }
