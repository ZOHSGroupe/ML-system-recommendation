...
21. **enable simple authentication, and set a username and password for your Kubeflow deployment:**
    ...
    ```
30. **finaly Open a browser and visit the following URL:**
...
# Airflow ML pipeline to repeat the training model every month
**Dag creation**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/dags.png)
**DAG pipline**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/dagGraph.png)
**DAG execution**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/dags-code.png)
**DAG statistics**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/dags-statistics.png)
**DAG landing times**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/dag-landing.png)

# monitoring kafka communication consumer and producer with confluent
**controle center**
![dag](https://github.com/ZOHSGroupe/ML-system-recommendation/blob/main/imgs/confluent.png)
